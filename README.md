...
GameAnalytics Roblox SDK for roblox-ts.

Documentation can be found [here](https://gameanalytics.com/docs/item/roblox-sdk).

If you have any issues or feedback regarding the SDK, please contact GameAnalytics's friendly support team [here](https://gameanalytics.com/contact).
